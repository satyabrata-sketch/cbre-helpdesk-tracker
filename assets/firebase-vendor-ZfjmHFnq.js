 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Af(r){const e=cn(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Uv(r,e,t){if(qe(r.app))return Promise.reject(nt(r));const n=cn(r),o=await Jo(n,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",iE).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&Af(r),u}),c=await sn._fromIdTokenResponse(n,"signIn",o);return await n._updateCurrentUser(c.user),c}function Bv(r,e,t){return qe(r.app)?Promise.reject(nt(r)):aE(fe(r),Hn.credential(e,t)).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&Af(r),n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jv(r,{displayName:e,photoURL:t}){if(e===void 0&&t===void 0)return;const n=fe(r),s={idToken:await n.getIdToken(),displayName:e,photoUrl:t,returnSecureToken:!0},o=await qn(n,cE(n.auth,s));n.displayName=o.displayName||null,n.photoURL=o.photoUrl||null;const c=n.providerData.find(({providerId:u})=>u==="password");c&&(c.displayName=n.displayName,c.photoURL=n.photoURL),await n._updateTokensIfNecessary(o)}function uE(r,e,t,n){return fe(r).onIdTokenChanged(e,t,n)}function lE(r,e,t){return fe(r).beforeAuthStateChanged(e,t)}function qv(r,e,t,n){return fe(r).onAuthStateChanged(e,t,n)}function zv(r){return fe(r).signOut()}const os="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
